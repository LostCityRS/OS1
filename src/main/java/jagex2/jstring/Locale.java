...
public class Locale {
	...
	@ObfuscatedName("ba.g")
	public static String field874 = "Connection lost";

	@ObfuscatedName("ba.q")
	public static String field875 = "Please wait - attempting to reestablish";

	@ObfuscatedName("ba.i")
	public static String field876 = "Starting game engine...";

	@ObfuscatedName("ba.s")
	public static String field1026 = "Prepared visibility map";

	@ObfuscatedName("ba.u")
	public static String field960 = "Connecting to update server";

	@ObfuscatedName("ba.v")
	public static String field1049 = "Checking for updates - ";

	@ObfuscatedName("ba.w")
	public static String field880 = "Loaded update list";

	@ObfuscatedName("ba.e")
	public static String field911 = "Prepared sound engine";

	@ObfuscatedName("ba.b")
	public static String field882 = "Loading fonts - ";

	@ObfuscatedName("ba.y")
	public static String field883 = "Loaded fonts";

	@ObfuscatedName("ba.t")
	public static String field884 = "Loading title screen - ";

	@ObfuscatedName("ba.f")
	public static String field885 = "Loaded title screen";

	@ObfuscatedName("ba.k")
	public static String field962 = "Loading config - ";

	@ObfuscatedName("ba.o")
	public static String field887 = "Loaded config";

	@ObfuscatedName("ba.a")
	public static String field888 = "Loading sprites - ";

	@ObfuscatedName("ba.h")
	public static String field889 = "Loaded sprites";

	@ObfuscatedName("ba.x")
	public static String field890 = "Loading textures - ";

	@ObfuscatedName("ba.p")
	public static String field891 = "Loaded textures";

	@ObfuscatedName("ba.ad")
	public static String field892 = "Loaded input handler";

	@ObfuscatedName("ba.ac")
	public static String field1062 = "Loading wordpack - ";

	@ObfuscatedName("ba.aa")
	public static String field1051 = "Loaded wordpack";

	@ObfuscatedName("ba.as")
	public static String field1017 = "Loading interfaces - ";

	@ObfuscatedName("ba.am")
	public static String field1045 = "Loaded interfaces";

	@ObfuscatedName("ba.ap")
	public static String field964 = "You have only just left another world.";

	@ObfuscatedName("ba.av")
	public static String field898 = "Your profile will be transferred in:";
	...
	public static String field1021 = "Your friend list is full. Max of 100 for free users, and 200 for members";

	@ObfuscatedName("ba.fd")
	public static String field913 = " is already on your friend list";

	@ObfuscatedName("ba.fb")
	public static String field1020 = "Your ignore list is full. Max of 100 users.";

	@ObfuscatedName("ba.fc")
	public static String field1024 = " is already on your ignore list";

	@ObfuscatedName("ba.fe")
	public static String field1069 = "You can't add yourself to your own friend list";

	@ObfuscatedName("ba.fj")
	public static String field1000 = "You can't add yourself to your own ignore list";

	@ObfuscatedName("ba.fp")
	public static String field1027 = "Please remove ";

	@ObfuscatedName("ba.fg")
	public static String field1052 = " from your ignore list first";

	@ObfuscatedName("ba.fv")
	public static String field1029 = "Please remove ";
	...
	public static String field1007 = "Enter your username/email & password.";
	...
	public static String field1070 = "Connecting to server...";

	@ObfuscatedName("ba.ga")
	public static String field998 = "";

	@ObfuscatedName("ba.go")
	public static String field903 = "Login: ";

	@ObfuscatedName("ba.gc")
	public static String field1073 = "Password: ";

	@ObfuscatedName("ba.hb")
	public static String field1074 = "Welcome to RuneScape";

	@ObfuscatedName("ba.hw")
	public static String field989 = "New User";

	@ObfuscatedName("ba.hv")
	public static String field1076 = "Existing User";

	@ObfuscatedName("ba.he")
	public static String field995 = "Login";

	@ObfuscatedName("ba.hk")
	public static String field1078 = "Cancel";
	...
	public static String field1066 = "Select a world";

	@ObfuscatedName("ba.hs")
	public static String field1085 = "Members only world";

	@ObfuscatedName("ba.hf")
	public static String field916 = "Free world";

	@ObfuscatedName("ba.hi")
	public static String field1087 = "World";

	@ObfuscatedName("ba.hd")
	public static String field894 = "Players";

	@ObfuscatedName("ba.ha")
	public static String field1091 = "Location";

	@ObfuscatedName("ba.hg")
	public static String field1090 = "Type";

	@ObfuscatedName("ba.hq")
	public static String field1012 = "OFF";

	@ObfuscatedName("ba.hh")
	public static String field1092 = "FULL";

	@ObfuscatedName("ba.ht")
	public static String field1093 = "Loading...";
