...
public class Client extends GameShell {
				...
				if (IfType.field373[var9] != null) {
					...
					for (int var11 = 0; var11 < IfType.field373[var9].length; var11++) {
						if (IfType.field373[var9][var11] != null) {
							if (IfType.field373[var9][var11].type == 2) {
								var10 = false;
							} else {
	...
	public static final void method344(int arg0, int arg1) {
		...
		boolean var13 = tryMove(localPlayer.pathTileX[0], localPlayer.pathTileZ[0], var11, var12, true, 0, 0, 0, 0, 0, 1);
		if (var13) {
			out.p1(var2);
			out.p1(var3);
	...
	public static final void pushPlayers(boolean local) {
		...
		for (int i = 0; i < count; i++) {
			...
			if (player.locModel == null || loopCycle < player.locStartCycle || loopCycle >= player.locEndCycle) {
				...
				scene.addTemporary(currentLevel, player.x, player.z, player.y, 60, player, player.yaw, var4, player.needsForwardDrawPadding);
			} else {
				player.lowMemory = false;
				player.y = getHeightmapY(player.x, player.z, currentLevel);
				scene.addTemporary(currentLevel, player.x, player.z, player.y, 60, player, player.yaw, var4, player.minTileX, player.minTileZ, player.maxTileX, player.maxTileZ);
			}
		}
	}
	...
	public static final void method7() {
		for (ProjAnimEntity var0 = (ProjAnimEntity) projectiles.head(); var0 != null; var0 = (ProjAnimEntity) projectiles.next()) {
			if (currentLevel != var0.field2583 || loopCycle > var0.field2573) {
				...
				scene.addTemporary(currentLevel, (int) var0.field2580, (int) var0.field2579, (int) var0.field2576, 60, var0, var0.field2586, -1, false);
			}
		}
	}
		...
		for (SpotAnimEntity var0 = (SpotAnimEntity) spotanims.head(); var0 != null; var0 = (SpotAnimEntity) spotanims.next()) {
			if (currentLevel != var0.field2604 || var0.field2605) {
				...
				if (var0.field2605) {
					...
					scene.addTemporary(var0.field2604, var0.field2610, var0.field2606, var0.field2611, 60, var0, 0, -1, false);
				}
			}
		}
	}
	...
	public static final void method1333(int arg0, int arg1) {
		if (field1920 == 2) {
			...
			if (field2140 > -1 && loopCycle % 20 < 10) {
				field1744[0].draw(field2140 + arg0 - 12, field2025 + arg1 - 28);
			}
		}
	}
	...
	public static final void method1843(int arg0, int arg1, int arg2, int arg3) {
		if (crossMode == 1) {
			field1767[crossCycle / 100].draw(field2026 - 8, field2027 - 8);
		}
		if (crossMode == 2) {
			field1767[crossCycle / 100 + 4].draw(field2026 - 8, field2027 - 8);
		}
		field2038 = 0;
	...
	public static final void method764(int arg0, int arg1, int arg2, int arg3, int arg4) {
		int var5 = scene.method590(arg0, arg1, arg2);
		if (var5 != 0) {
			int var6 = scene.method594(arg0, arg1, arg2, var5);
			int var7 = var6 >> 6 & 0x3;
			int var8 = var6 & 0x1F;
			int var9 = arg3;
			if (var5 > 0) {
		...
		int var17 = scene.method592(arg0, arg1, arg2);
		if (var17 != 0) {
			int var18 = scene.method594(arg0, arg1, arg2, var17);
		...
		int var29 = scene.method593(arg0, arg1, arg2);
		if (var29 == 0) {
			return;
		}
	...
	public static final boolean method1149(int arg0, int arg1, int arg2) {
		...
		int var4 = scene.method594(currentLevel, arg0, arg1, arg2);
		if (var4 == -1) {
			return false;
		}
		int var5 = var4 & 0x1F;
	...
	public static final void readZonePacket() {
		if (packetType == 245) {
			...
			if (player != null) {
				...
				SoftwareModel var27 = loc.method2386(var3, var4, var23, var25, locOffsetY, var26);
				if (var27 != null) {
			...
			if (var47 >= 0 && var48 >= 0 && var47 < 103 && var48 < 103) {
				if (var52 == 0) {
					Wall var53 = scene.method715(currentLevel, var47, var48);
					if (var53 != null) {
				...
				if (var52 == 1) {
					Decor var55 = scene.method602(currentLevel, var47, var48);
					if (var55 != null) {
				...
				if (var52 == 2) {
					Location var57 = scene.method686(currentLevel, var47, var48);
					if (var50 == 11) {
						var50 = 10;
					}
					if (var57 != null) {
				...
				if (var52 == 3) {
					GroundDecor var58 = scene.method621(currentLevel, var47, var48);
					if (var58 != null) {
	...
	public static final void method1447(LocSpawned arg0) {
		...
		int var4 = 0;
		if (arg0.field1630 == 0) {
			var1 = scene.method590(arg0.field1638, arg0.field1633, arg0.field1632);
		}
		if (arg0.field1630 == 1) {
			var1 = scene.method591(arg0.field1638, arg0.field1633, arg0.field1632);
		}
		if (arg0.field1630 == 2) {
			var1 = scene.method592(arg0.field1638, arg0.field1633, arg0.field1632);
		}
		if (arg0.field1630 == 3) {
			var1 = scene.method593(arg0.field1638, arg0.field1633, arg0.field1632);
		}
		if (var1 != 0) {
			int var5 = scene.method594(arg0.field1638, arg0.field1633, arg0.field1632, var1);
			var2 = var1 >> 14 & 0x7FFF;
			var3 = var5 & 0x1F;
			var4 = var5 >> 6 & 0x3;
		}
	...
	public static final void method274(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5, int arg6) {
		...
		boolean var10 = false;
		if (arg1 == 0) {
			var7 = scene.method590(arg0, arg2, arg3);
		}
		if (arg1 == 1) {
			var7 = scene.method591(arg0, arg2, arg3);
		}
		if (arg1 == 2) {
			var7 = scene.method592(arg0, arg2, arg3);
		}
		if (arg1 == 3) {
			var7 = scene.method593(arg0, arg2, arg3);
		}
		if (var7 != 0) {
			int var11 = scene.method594(arg0, arg2, arg3, var7);
			int var12 = var7 >> 14 & 0x7FFF;
			int var13 = var11 & 0x1F;
			int var14 = var11 >> 6 & 0x3;
			if (arg1 == 0) {
				scene.method581(arg0, arg2, arg3);
			...
			if (arg1 == 1) {
				scene.method582(arg0, arg2, arg3);
			}
			if (arg1 == 2) {
				scene.method583(arg0, arg2, arg3);
			...
			if (arg1 == 3) {
				scene.method584(arg0, arg2, arg3);
		...
		World.method918(arg0, var18, arg2, arg3, arg4, arg5, arg6, scene, levelCollisionMap[arg0]);
	}
	...
	public static final void method1486(int arg0, int arg1) {
		...
		if (var2 == null) {
			scene.method666(currentLevel, arg0, arg1);
			return;
		}
		int var3 = -99999999;
		...
		scene.method571(currentLevel, arg0, arg1, getHeightmapY(arg0 * 128 + 64, arg1 * 128 + 64, currentLevel), var4, var11, var8, var9);
	}
	...
	public static final void useMenuOption(int arg0) {
		...
		if (var3 == 23) {
			scene.method601(currentLevel, var1, var2);
		}
		if (var3 == 4) {
			method1149(var1, var2, var4);
			out.pisaac1(90);
	...
	public static final void method92(IfType[] arg0, int arg1, int arg2, int arg3, int arg4, int arg5, int arg6, int arg7, int arg8) {
		...
		for (int var9 = 0; var9 < arg0.length; var9++) {
            ...
            if (var10.type == 0) {
                ...
                if (!var10.if3) {
                    if (var10.field1797 > var10.scroll - var10.height) {
                        var10.field1797 = var10.scroll - var10.height;
                    }
            ...
            if (var10.type == 0 && !var10.if3 && var10.scroll > var10.height) {
                imethod36(var13, var10.width + var12, var10.field1797, var10.height, var10.scroll);
                            ...
                            if (var174 + 32 > arg2 && var174 < arg4 && var175 + 32 > arg3 && var175 < arg5 || objDragInterface == var10 && hoveredSlot == var171) {
                                ...
                                if (var179 == null) {
                                    ...
                                    if (arg1 != -1) {
                                        ...
                                        if (var175 + var181 + 32 > Pix2D.bottom && var182.field1797 < var182.scroll - var182.height) {
                                            int var184 = sceneDelta * (var175 + var181 + 32 - Pix2D.bottom) / 3;
                                            if (var184 > sceneDelta * 10) {
                                                var184 = sceneDelta * 10;
                                            }
                                            if (var184 > var182.scroll - var182.height - var182.field1797) {
                                                var184 = var182.scroll - var182.height - var182.field1797;
                                            }
                ...
                if (var187 != null) {
                    ...
                    var187.method2824(var188, var12, var13, var10.width, var10.height, var189, var10.shadowed ? 0 : -1, var10.center, var10.field1834, var10.field1832);
                } else if (IfType.field1870) {
                    method1238(var10);
                }
                ...
                if (var10.if3) {
                    ...
                    if (var10.field1791 == -1) {
                        ...
                        var192 = ObjType.getIcon(var10.field1791, var10.field1888, var10.field1811, var10.field1812, false);
                    }
                    if (var192 != null) {
                        ...
                        if (var10.field1794) {
                            ...
                            if (var10.field1784 != 0) {
                                var192.method2685(var10.width / 2 + var12, var10.height / 2 + var13, var10.field1784, var199);
                            } else if (var14 != 0) {
                ...
                if (var202 != null) {
                    if (var10.if3) {
                        var202.method3002();
                        if (var10.field1828) {
                            var202.method3020(0, var10.yan, var10.field1817, var10.xan, var10.field1821, var10.field1798 + var203 + var207, var10.field1798 + var208, var10.zoom);
                        } else {
                            var202.method3014(0, var10.yan, var10.field1817, var10.xan, var10.field1821, var10.field1798 + var203 + var207, var10.field1798 + var208);
                        }
                    } else {
                ...
                for (int var211 = 0; var211 < var10.height; var211++) {
                    for (int var212 = 0; var212 < var10.width; var212++) {
                        if (var10.invSlotObjId[var210] > 0) {
                            ...
                            if (var10.center == 0) {
                                var209.method2821(var214, var215, var216, var10.colour, var10.shadowed ? 0 : -1);
                            } else if (var10.center == 1) {
                                var209.method2880(var214, var10.width / 2 + var215, var216, var10.colour, var10.shadowed ? 0 : -1);
                            } else {
                                var209.method2864(var214, var10.width + var215 - 1, var216, var10.colour, var10.shadowed ? 0 : -1);
                            }
                        }
                        var210++;
                    }
				...
				if (!var9.if3 || var12 < var14 && var13 < var15) {
					if (var9.clientCode == 1337) {
						...
						if (!var9.if3) {
							...
							if (var9.scroll > var9.height) {
								method97(var9, var9.width + var10, var11, var9.height, var9.scroll, JavaMouseProvider.mouseX, JavaMouseProvider.mouseY);
							}
						}
					}
				}
	...
	public static final void method1146(IfType[] arg0, int arg1) {
		for (int var2 = 0; var2 < arg0.length; var2++) {
			IfType var3 = arg0[var2];
			if (var3 != null && var3.layerid == arg1 && (!var3.if3 || !method868(var3))) {
				if (var3.type == 0) {
					if (!var3.if3 && method868(var3) && field37 != var3) {
						continue;
					}
				...
				if (var3.type == 6) {
					if (var3.anim != -1 || var3.activeAnim != -1) {
						boolean var6 = method56(var3);
						int var7;
						if (var6) {
							var7 = var3.activeAnim;
						} else {
							var7 = var3.anim;
						}
						if (var7 != -1) {
			...
			if (IfType.field373[var2] != null) {
				...
				for (int var5 = 0; var5 < IfType.field373[var2].length; var5++) {
					if (IfType.field373[var2][var5] != null) {
						if (IfType.field373[var2][var5].type == 2) {
							var4 = false;
						} else {
	...
	public static final void method915(int arg0, int arg1, int arg2) {
		method1351();
		Pix2D.setBounds(arg0, arg1, field807.field2513 + arg0, field807.field2514 + arg1);
	...
	public static final void addMessage(int arg0, String arg1, String arg2) {
	...
	public static void imethod4() {
		...
		if (lowMemory) {
			scene.method565(World.currentLevel);
		} else {
			scene.method565(0);
		}
		...
		try {
			...
			if (packetType == 72) {
				for (int var329 = 0; var329 < players.length; var329++) {
					if (players[var329] != null) {
						players[var329].primarySeqId = -1;
					}
				}
				for (int var330 = 0; var330 < npcs.length; var330++) {
					if (npcs[var330] != null) {
						npcs[var330].primarySeqId = -1;
					}
				}
				packetType = -1;
				return true;
			...
			if (packetType == 50) {
				...
				if (var333 != null && var333.type == 0) {
					if (var332 > var333.scroll - var333.height) {
						var332 = var333.scroll - var333.height;
					}
					if (var332 < 0) {
						var332 = 0;
					}
	...
	public static void imethod21(int var25, PlayerEntity var26, int var27) {
		if ((var27 & 0x4) != 0) {
			...
			if (var26.name != null && var26.field2786 != null) {
				boolean var32 = false;
				if (var29 <= 1 && method761(var26.name)) {
					var32 = true;
				}
		...
		if ((var27 & 0x1) != 0) {
			...
			if (var26.field2644.charAt(0) == '~') {
				...
				addMessage(2, var26.name, var26.field2644);
				...
				if (var406 >= 103) {
					...
					for (int var413 = 0; var413 < 104; var413++) {
						for (int var414 = 0; var414 < 104; var414++) {
							int var415 = scene.method593(currentLevel, var413, var414);
							if (var415 != 0) {
	...
	public static void imethod34(int var12, int var13, int var31, int var32) {
		...
		method1351();
		scene.method609(cameraX, cameraY, cameraZ, cameraPitch, cameraYaw, var62);
		method1351();
		scene.method578();
	...
	public static void imethod35(IfType var10, int var129, int var130) {
		if (var10.buttonType == 1) {
			method8(var10.option, "", 24, 0, 0, var10.field1783);
		}
		if (var10.buttonType == 2 && !field2079) {
			...
			if (var131 != null) {
				method8(var131, TextUtil.colTag(65280) + var10.targetText, 25, 0, -1, var10.field1783);
			}
		}
		...
		if (var10.buttonType == 5) {
			method8(var10.option, "", 29, 0, 0, var10.field1783);
		}
		if (var10.buttonType == 6 && field2087 == null) {
			method8(var10.option, "", 30, 0, -1, var10.field1783);
		}
		if (var10.type == 2) {
			int var133 = 0;
						...
						if (var10.invSlotObjId[var133] > 0) {
							label1831: {
								...
								if (field2079) {
									...
									if (var142) {
										if ((field386 & 0x10) == 16) {
											method8(field2048, field2082 + " " + TextUtil.arrow + " " + TextUtil.colTag(16748608) + var138.name, 32, var138.index, var133, var10.field1783);
										}
										break label1831;
									}
								}
								...
								if (var151 && var143 != null) {
									for (int var152 = 2; var152 >= 0; var152--) {
										if (var143[var152] != null) {
											...
											method8(var143[var152], TextUtil.colTag(16748608) + var138.name, var153, var138.index, var133, var10.field1783);
										}
									}
								}
								...
								if (var154 != null) {
									for (int var155 = 4; var155 >= 0; var155--) {
										if (var154[var155] != null) {
											...
											method8(var154[var155], TextUtil.colTag(16748608) + var138.name, var156, var138.index, var133, var10.field1783);
										}
									}
								}
			...
			if (var75 != null && var75.isVisible()) {
				...
				if (var74 >= playerCount) {
					...
					if (var79.headicon >= 0 && var79.headicon < field187.length) {
						...
						if (field2140 > -1) {
							field187[var79.headicon].draw(field2140 + var12 - 12, field2025 + var13 - 30);
						}
					}
					if (field1920 == 1 && field1931 == field1956[var74 - playerCount] && loopCycle % 20 < 10) {
						method948(var75, var75.field2626 + 15);
						if (field2140 > -1) {
							field1744[0].draw(field2140 + var12 - 12, field2025 + var13 - 28);
						}
					}
				} else {
					int var77 = 30;
					...
					if (var78.field2787 != -1 || var78.field2800 != -1) {
						...
						if (field2140 > -1) {
							if (var78.field2787 != -1) {
								field816[var78.field2787].draw(field2140 + var12 - 12, field2025 + var13 - var77);
								var77 += 25;
							}
							if (var78.field2800 != -1) {
								field187[var78.field2800].draw(field2140 + var12 - 12, field2025 + var13 - var77);
								var77 += 25;
							}
						}
					}
					if (var74 >= 0 && field1920 == 10 && field1932 == playerIds[var74]) {
						method948(var75, var75.field2626 + 15);
						if (field2140 > -1) {
							field1744[1].draw(field2140 + var12 - 12, field2025 + var13 - var77);
						}
					}
				}
				if (var75.field2644 != null && (var74 >= playerCount || field2145 == 0 || field2145 == 3 || field2145 == 1 && method785(((PlayerEntity) var75).name))) {
				...
				for (int var81 = 0; var81 < 4; var81++) {
					if (var75.field2633[var81] > loopCycle) {
						...
						if (field2140 > -1) {
							...
							field1157[var75.field2632[var81]].draw(field2140 + var12 - 12, field2025 + var13 - 12);
		...
		for (int var82 = 0; var82 < field2012; var82++) {
			...
			if (field2085 == 0) {
				...
				if (field2019[var82] == 1) {
					field704.method2825(var89, field2140 + var12, field2025 + var13, var90, 0, sceneCycle);
				}
				if (field2019[var82] == 2) {
					field704.method2826(var89, field2140 + var12, field2025 + var13, var90, 0, sceneCycle);
				}
				if (field2019[var82] == 3) {
					field704.method2827(var89, field2140 + var12, field2025 + var13, var90, 0, sceneCycle, 150 - field2020[var82]);
				}
	...
	public static void imethod41(int var12, int var13, int var72, int var73) {
		...
		for (int var101 = 0; var101 < SoftwareModel.field2741; var101++) {
            ...
            var100 = var102;
            if (var105 == 2 && scene.method594(currentLevel, var103, var104, var102) >= 0) {
                ...
                if (var111.type.size == 1 && (var111.x & 0x7F) == 64 && (var111.z & 0x7F) == 64) {
                    for (int var112 = 0; var112 < npcCount; var112++) {
                        ...
                        if (var113 != null && var111 != var113 && var113.type.size == 1 && var111.x == var113.x && var111.z == var113.z) {
                            method64(var113.type, field1956[var112], var103, var104);
                        }
                    }
                ...
                if ((var116.x & 0x7F) == 64 && (var116.z & 0x7F) == 64) {
                    for (int var117 = 0; var117 < npcCount; var117++) {
                        ...
                        if (var118 != null && var118.type.size == 1 && var116.x == var118.x && var116.z == var118.z) {
                            method64(var118.type, field1956[var117], var103, var104);
                        }
                    }
