...
public class PlayerModel {
	...
	public Model method1174(SeqType arg0, int arg1, SeqType arg2, int arg3) {
		if (this.field1225 != -1) {
		...
		Model var9 = (Model) field1231.get(var5);
		if (var9 == null) {
			boolean var10 = false;
			...
			if (var10) {
				if (this.field1227 != -1L) {
					var9 = (Model) field1231.get(this.field1227);
				}
				if (var9 == null) {
					return null;
				}
			...
			if (var9 == null) {
				ModelMetadata[] var13 = new ModelMetadata[12];
				int var14 = 0;
				for (int var15 = 0; var15 < 12; var15++) {
					int var16 = var7[var15];
					if (var16 >= 256 && var16 < 512) {
						ModelMetadata var17 = IdkType.get(var16 - 256).getModel();
						if (var17 != null) {
							var13[var14++] = var17;
						}
					}
					if (var16 >= 512) {
						ModelMetadata var18 = ObjType.get(var16 - 512).getWornModel(this.field1222);
						if (var18 != null) {
							var13[var14++] = var18;
						}
					}
				}
				ModelMetadata var19 = new ModelMetadata(var13, var14);
	...
	public ModelMetadata method1192() {
		if (this.field1225 != -1) {
		...
		ModelMetadata[] var4 = new ModelMetadata[12];
		int var5 = 0;
		for (int var6 = 0; var6 < 12; var6++) {
			int var7 = this.field1228[var6];
			if (var7 >= 256 && var7 < 512) {
				ModelMetadata var8 = IdkType.get(var7 - 256).getHeadModel();
				if (var8 != null) {
					var4[var5++] = var8;
				}
			}
			if (var7 >= 512) {
				ModelMetadata var9 = ObjType.get(var7 - 512).getHeadModel(this.field1222);
				if (var9 != null) {
					var4[var5++] = var9;
				}
			}
		}
		ModelMetadata var10 = new ModelMetadata(var4, var5);
